 ...
 *
 * The delay is the same every attempt, capped at `maxDelayMs`, and is then randomised across its whole range, so clients failing together do not retry together.
 *
